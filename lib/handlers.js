...
handlers._redir.get = function(data, res){
  ...
  helpers.shortLink(idNoticia, idProdutoMvc).then(function (respLink){
    ...
    var fonte = respLink.Fonte;
    var dataHora = respLink.DataHora;
    var duracao = respLink.Duracao;
    ...
    var resObj ={
      ...
      "DataHora": dataHora,
      "Duracao": duracao,
      "Url": `http://ec2-54-89-249-90.compute-1.amazonaws.com:5000/static/${fileName}.html`
    }
