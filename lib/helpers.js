...
helpers.getNoticia = function(idNoticia, idProdutoMvc){
  ...
  console.log(idProdutoMvc)
  let postData = `${idNoticia}&${idProdutoMvc}`
  console.log(idNoticia.indexOf('=') > -1)
  if (idNoticia.indexOf('=') > -1) {
...
helpers.shortLink = function (idNoticia, idProdutoMvc){
  ...
  console.log(Number.parseInt(idNoticia) == NaN)
  let postData = `idNoticia=${idNoticia}&idProdutoMvc=${idProdutoMvc}`
  if (Number.parseInt(idNoticia) == NaN) {
    postData = `${idNoticia}&${idProdutoMvc}`
  }
  console.log(postData)
